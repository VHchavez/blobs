...
class Manager():
    ...
    def plot(self, cube_file, iso=0.03, cube_type="density", colorscale="Blues", size=1, plot_geometry=True, plot_bonds=True):
        ...
        if plot_geometry==True:
            ...
            geo_data = go.Scatter3d(
            x=self.info["x"], y=self.info["y"], z=self.info["z"],
            mode="markers",
        ...
        if plot_bonds==True:
            ...
            for i in range(len(bonds)):
                ...
                fig.add_trace(go.Scatter3d(x = bond_x, y = bond_y, z = bond_z, 
                            mode = "lines", 
                            line={"color":"grey", 
                                  "width":2},
                            ))  
